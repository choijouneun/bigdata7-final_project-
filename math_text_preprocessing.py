...
class OpenAIImageQuestioner:
    def __init__(self, api_key, base_directory, output_directory):
    ...
    def process_images(self, question):
        ...
        # Get directory name to use as file name
        directory_name = os.path.basename(os.path.normpath(self.base_directory))
        output_file = os.path.join(self.output_directory, f"{directory_name}.json")
